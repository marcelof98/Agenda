...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { nome: @contato.nome, numero: @contato.numero } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { nome: @contato.nome, numero: @contato.numero } }
